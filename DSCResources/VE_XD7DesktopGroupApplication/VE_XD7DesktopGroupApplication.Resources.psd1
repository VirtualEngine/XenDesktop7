<# VE_XD7DesktopGroupApplication\VE_XD7DesktopGroupApplication.Resources.psd1 #>
ConvertFrom-StringData @'
    ...
    UpdatingApplication           = Updating Citrix XenDesktop 7.x application '{0}'.
    RemovingApplication           = Removing Citrix XenDesktop 7.x application '{0}'.
    InvokingScriptBlockWithParams = Invoking script block with parameters: '{0}'.
    ResourceInDesiredState        = Citrix XenDesktop 7.x application '{0}' is in the desired state.
    ResourceNotInDesiredState     = Citrix XenDesktop 7.x application '{0}' is NOT in the desired state.
'@
