...
ConvertFrom-StringData @'
    ...
    ResourceInDesiredState                = Citrix StoreFront WebReceiver communication settings are in the desired state.
    ResourceNotInDesiredState             = Citrix StoreFront WebReceiver communication settings are NOT in the desired state.
'@
