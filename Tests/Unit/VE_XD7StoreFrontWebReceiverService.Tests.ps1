...
InModuleScope $sut {
    ...
    function Set-STFWebReceiverService { }

    function Add-STFWebReceiverService { }

    function Remove-STFWebReceiverService { }

    Describe 'XenDesktop7\VE_XD7StoreFrontWebReceiverService' {
