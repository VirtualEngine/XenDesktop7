...
InModuleScope $sut {
    ...
    function Set-STFRoamingGateway { }

    function Add-STFRoamingGateway { }

    function Remove-STFRoamingGateway { }

    Describe 'XenDesktop7\VE_XD7StoreFrontRoamingGateway' {
