...
InModuleScope $sut {
    ...
    function Get-DSResourceFilterKeyword { }

    function Set-DSResourceFilterKeyword { }

    Describe 'XenDesktop7\VE_XD7StoreFrontFilterKeyword' {
        ...
        Context 'Set-TargetResource' {
            ...
            It 'Does not throw' {
                ...
                { Set-TargetResource @testResource -IncludeKeywords 'test' } | Should Not Throw;
            }
