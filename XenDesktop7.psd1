@{
    ...
    DscResourcesToExport = @('XD7AccessPolicy', 'XD7Administrator', 'XD7Catalog', 'XD7CatalogMachine', 'XD7Controller', 'XD7Database', 'XD7DesktopGroup', 'XD7DesktopGroupApplication', 'XD7DesktopGroupMember',
                                'XD7EntitlementPolicy', 'XD7Feature', 'XD7Role', 'XD7Site', 'XD7SiteLicense', 'XD7StoreFrontBaseUrl', 'XD7VDAController', 'XD7VDAFeature', 'XD7WaitForSite');
    PrivateData = @{
        PSData = @{
